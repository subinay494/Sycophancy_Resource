...
Usage:
  python scripts/llm_sycophancy_speculative_variants_gemma3.py            # 5 cases
  python scripts/llm_sycophancy_speculative_variants_gemma3.py -n 10      # 10 cases
  python scripts/llm_sycophancy_speculative_variants_gemma3.py --all      # all 300
"""
...
MODEL_TAG = "gemma-3-27b-it-local"
DEFAULT_N_CASES = 5
...
def load_engine():
    ...
    llm = LLM(
        ...
        max_model_len=4096,        # conservative for ~52 GB model on 80 GB GPU
