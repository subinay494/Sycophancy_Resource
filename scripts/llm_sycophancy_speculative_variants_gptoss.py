...
Usage:
  python scripts/llm_sycophancy_speculative_variants_gptoss.py            # 5 cases
  python scripts/llm_sycophancy_speculative_variants_gptoss.py -n 10      # 10 cases
  python scripts/llm_sycophancy_speculative_variants_gptoss.py --all      # all 300
"""
...
def load_engine():
    ...
    print(f"\n{'='*70}")
    print(f"  Loading GPT-OSS-20B via vLLM  (native mxfp4, no extra quant)")
    ...
    llm = LLM(
        ...
        max_model_len=8192,        # sufficient for legal prompts + response
